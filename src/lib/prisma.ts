...
if (process.env.NODE_ENV !== 'production' && globalThis.prismaNew && !(globalThis.prismaNew as any).training) {
    console.warn('[DB] Stale Prisma instance detected (missing Training model). Clearing global cache...');
