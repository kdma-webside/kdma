        ...
        <div className="flex items-center space-x-4 lg:space-x-8 relative z-[110]">
          ...
          {pathname === '/store' && (
            <motion.button
              ...
              className="flex items-center gap-3 bg-white/5 border border-white/10 text-white px-4 lg:px-5 py-3 rounded-full hover:bg-white/10 active:bg-white/20 active:scale-95 transition-all group pointer-events-auto"
            >
          ...
          <div className="hidden md:flex items-center space-x-6">
            <Link
              href="/signin"
              className="text-white text-[10px] tracking-[0.2em] font-black uppercase hover:text-orange-500 active:text-orange-600 transition-colors"
            >
              Sign In
            </Link>
            <Link
              href="/register"
              className="bg-orange-600 text-white px-8 py-3 rounded-full text-[10px] font-black tracking-[0.2em] uppercase hover:bg-orange-700 hover:scale-105 active:scale-95 transition-all shadow-[0_10px_20px_-5px_rgba(234,88,12,0.4)]"
            >
              Register
            </Link>
          </div>
          ...
          >
            <div className="flex flex-col items-center space-y-10 w-full">
              ...
              >
                <Link
                  href="/signin"
                  className="text-white text-sm tracking-[0.3em] font-black uppercase hover:text-orange-500 transition-colors"
                >
                  Sign In
                </Link>
                <Link
