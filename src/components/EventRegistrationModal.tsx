...
const EventRegistrationModal = ({ event, isOpen, onClose }: EventRegistrationModalProps) => {
    ...
    const formConfig: FieldConfig[] = event.formConfig
        ? (typeof event.formConfig === 'string' ? JSON.parse(event.formConfig) : event.formConfig)
        : [];
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await registerForEvent(event.id, {
                userName: formData['Name'] || formData['name'] || formData['username'] || 'Anonymous',
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    >
                        ...
                        <div className="mb-8">
                            ...
                            <h2 className="text-white text-3xl font-black uppercase tracking-tight">{event.title}</h2>
                        </div>
                        ...
                        {status === 'success' ? (
                            <div className="flex flex-col items-center justify-center py-12 text-center text-white">
                                ...
                                <p className="text-gray-400">See you at the arena.</p>
                            </div>
                        ) : (
